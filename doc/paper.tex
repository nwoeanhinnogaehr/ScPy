...
\title{ScPy: A SuperCollider Extension for Perforeing Numerical Computation via Embedded Python}
...
then converted to \texttt{lists} of \texttt{ndarray} objects in Python. These are a bit more
